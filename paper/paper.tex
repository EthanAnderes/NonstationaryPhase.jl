...
\textcolor{red}{
Try and add this to the intro... emphasize that the form of the local invariant nonstationarity gives this quasi-stationary form in the Fourier domain which allows FFT methods for empirical cov estimation.
\begin{align}
...
\textcolor{red}{Be explicit that all function defined on $\Bbb R^d$ are periodic and the integrals over real space are restricted to one periodic region etc...}
...
\textcolor{red}{Consider giving the estimate up front, along with the FFT represention, then explain where it comes from.}
...
\textcolor{red}{Consider giving the explicit derivative form of $\bs C^{(1)}(\bs x-\bs y)$.}
...
\textcolor{red}{Re-write this part to be explicit about what is rigourous and what is not. Maybe consider moving the rigourous algebraic manipuliations relating the Fourier characterization and the fast algorithm to a claim in the main body of the paper.}
\textcolor{magenta}{Consider actually proving (or citing) that the periodic transform follows the same behavior of the continuous trasform, whereby justifying the notational convention.}
